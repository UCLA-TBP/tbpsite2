...
import { OfficerCommitteeSelector } from "../components/OfficerCommitteeHelpers";
...
const CandidateTracker = () => {
    ...
    const handleSave = (e) => {
        axios
            .put(
                "/api/user/update-user/" + selectedCandidate._id,
                selectedCandidate
            )
            .then((res) => {
                axios
    ...
    const handleDelete = (e) => {
        axios
            .put(
                "/api/user/delete-user/" + selectedCandidate._id,
                selectedCandidate
            )
            .then((res) => {
                axios
                ...
                <Box
                    sx={{
                        backgroundColor: (theme) =>
                            alpha(theme.palette.custom.main, 0.95),
                        borderRadius: "12px",
                    }}
                    p={5}
                >
                ...
                {selectedCandidate && (
                    ...
                    >
                        ...
                        {selectedCandidate.tutoringLog?.length ? (
                            selectedCandidate.tutoringLog.map(
                                (entry, index) => (
                                    <Grid
                                        key={index}
                                        container
                        ...
                        <UserInfo selectedUser={selectedCandidate} />
                ...
                <Snackbar
                    ...
                    sx={{
                        "& .MuiSnackbarContent-root": {
                            ...
                            backgroundColor: (theme) =>
                                theme.palette.secondary.main, //your custom color here
                        },
                    }}
                />
            </Container>
